   <footer>
      ...
      <!-- footer-area-start -->
      <section class="it-footer-wrap it-footer-style-2 fix" style="background:rgb(26 90 182 / 10%);">
         <div class="it-footer-area z-index-1 pt-50 pb-40">
               ...
               <div class="row">
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                     ...
                     <div class="it-footer-widget it-footer-col-1-1">
                        <div class="it-footer-widget-logo mb-30">
                           <a href="index.php"><img src="{{ asset('assets/img/KYMS.png') }}" alt="kyms-logo" style="height:60px"></a>
                        </div>
                        <div class="it-footer-widget-text">
                           <p>KYMS Academy provides expert-led coaching for CAT, IPMAT, CUET, CLAT and other entrance exams, helping students achieve top results.</p>
                        </div>
                     ...
                     <div class="it-footer-widget it-footer-col-1-3">
                        ...
                        <div class="it-footer-widget-menu">
                           <ul>
                              ...
                              <li><a href="school-list.php">B-Schools</a></li>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     <div class="it-footer-widget it-footer-col-1-2">
                        <h4 class="it-footer-widget-title">Programs</h4>
                        <div class="it-footer-widget-menu">
                           <ul>
                              <li><a href="#">CAT Preparation</a></li>
                              <li><a href="#">CLAT Preparation</a></li>
                              <li><a href="#">CUET Preparation</a></li>
                              <li><a href="#">GMAT Preparation</a></li>
                              <li><a href="#">IPMAT Preparation</a></li>
                           </ul>
                     ...
                     <div class="it-footer-widget it-footer-col-1-4 d-flex justify-content-lg-end">
                        <div>
                           ...
                           <div class="it-footer-widget-contact mb-25">
                              <ul>
                                 <li><span>Phone:</span><a href="tel:9039343403">9039343403</a></li>
                                 <li><span>Email:</span><a href="mailto:info@kymsacademy.com">info@kymsacademy.com</a></li>
                                 <li><span>Location:</span><a target="_blank" href="https://www.google.com/maps/search/Kysm+Academy+Indore/@22.7195687,75.8577258,12z?entry=ttu">Indore, Madhya Pradesh</a></li>
                              </ul>
                           </div>
               ...
               <div class="row align-items-center">
                  <div class="col-12">
                     <div class="it-copyright-left style-2 text-center">
                        <p class="mb-0 footer-custom">Copyright © 2026 <a href="#" target="_blank"><strong> KYMS Academy </strong></a> All Rights Reserved || Developed By <a href="https://www.indiawebsoft.com/"><strong>India Websoft</strong></a></p>
                     </div>
                  </div>
               </div>
            </div>
