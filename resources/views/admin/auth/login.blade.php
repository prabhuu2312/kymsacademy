...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets-admin/img/KYMS.png') }}">
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="logo-section">
            <img src="{{ asset('assets-admin/img/KYMS.png') }}" alt="KYMS Academy" class="logo-img">
        ...
        <form method="POST" action="{{ url('/admin/login') }}" id="loginForm">
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="login-button" id="loginBtn">
